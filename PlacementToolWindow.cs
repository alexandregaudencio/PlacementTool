...
namespace PlacementTool
{
    public class PlacementToolWindow : EditorWindow
    {
        ...
        public static void ShowWindow()
        {
            ...
            window = EditorWindow.GetWindow<PlacementToolWindow>(true, "Placement Fool");
        }
            ...
            if (enabled)
            {
                ...
                if (Event.current.type == EventType.MouseDown && Event.current.button == 0)
                {
                    ...
                    if (Physics.Raycast(ray, out hit))
                    {
                        ...
                        if (UnityEditor.Selection.activeGameObject != null && UnityEditor.Selection.activeTransform == null)
                        {
        ...
        void OnGUI()
        {
            ...
            if (enabled == false)
            {
                ...
                //}
                //var enableButtonStyle = new GUIStyle(GUI.skin.button);
            ...
            else if (enabled == true)
            {
                ...
                {
                    if (UnityEditor.Selection.activeGameObject != null)// && Selection.activeTransform != null)
                    {
                        selectedGroup = UnityEditor.Selection.activeGameObject;
                    }
                }
